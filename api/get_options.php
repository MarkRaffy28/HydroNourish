...
/**
 * ESP32 / Global API - Fetch System Options
 * Returns all system-wide configurations from the options table.
 */
...
try {
    ...
    if ($result && $row = $result->fetch_assoc()) {
        ...
        // Explicitly cast numeric configurations for strict ESP32 ArduinoJson parsing
        $numeric_fields = [
        ...
        // Auto-clear the RTC Sync tag securely so the ESP doesn't get stuck continually resetting its clock backward
